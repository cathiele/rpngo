...
func TestExec(t *testing.T) {
	data := []struct {
		...
		},
		{
			...
			args:       []string{"10"},
			frameCount: 1,
			wantFrame:  ComplexFrame(10, COMPLEX_FRAME),
		},
		{
			name:       "complex 2",
			args:       []string{"-10"},
		...
		},
		{
			...
			args:       []string{"i"},
			frameCount: 1,
			wantFrame:  ComplexFrame(complex(0, 1), COMPLEX_FRAME),
		},
		{
			name:       "complex 4",
			args:       []string{"-i"},
		...
		},
		{
			...
			args:       []string{"10i"},
			frameCount: 1,
			wantFrame:  ComplexFrame(complex(0, 10), COMPLEX_FRAME),
		},
		{
			name:       "complex 6",
			args:       []string{"-10i"},
		...
		},
		{
			...
			args:       []string{".2+3i"},
			frameCount: 1,
			wantFrame:  ComplexFrame(complex(0.2, 3), COMPLEX_FRAME),
		},
		{
			name:       "complex 8",
			args:       []string{"2-30.2i"},
			frameCount: 1,
			wantFrame:  ComplexFrame(complex(2, -30.2), COMPLEX_FRAME),
		},
		{
			name:       "complex 9",
			args:       []string{"-20+0.3i"},
			frameCount: 1,
			wantFrame:  ComplexFrame(complex(-20, 0.3), COMPLEX_FRAME),
		},
		{
			name:       "complex 10",
			args:       []string{"-0.2-.3i"},
			frameCount: 1,
			wantFrame:  ComplexFrame(complex(-0.2, -0.3), COMPLEX_FRAME),
		},
		{
			name:       "polar 1",
			args:       []string{"1<0"},
		...
		},
		{
			...
			args:       []string{"0", "mi>km"},
			frameCount: 1,
			wantFrame:  ComplexFrame(0, COMPLEX_FRAME),
		},
		{
			name: "help all",
			args: []string{"?"},
