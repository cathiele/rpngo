...
func RegisterAll(r *rpn.RPN) {
	...
	r.Register("deg", Deg, rpn.CatEng, DegHelp)
	r.Register("getangle", GetAngle, rpn.CatEng, GetAngleHelp)
	r.Register("grad", Grad, rpn.CatEng, GradHelp)
	r.Register("log", Log, rpn.CatEng, LogHelp)
	r.Register("log10", Log10, rpn.CatEng, Log10Help)
	r.Register("rad", Rad, rpn.CatEng, RadHelp)
	r.Register("rand", Rand, rpn.CatEng, RandHelp)
	r.Register("setangle", SetAngle, rpn.CatEng, SetAngleHelp)
